        ...
        <article className="grid grid-flow-col grid-cols-2">
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <h2 className="text-center text-xl font-normal text-white sm:text-2xl">
              ...
              <br />
              Fill out the form to the right and we&apos;ll get back to you as
              soon as possible!
            </h2>
          </div>
          <div className="word-spacing-half flex flex-col items-center justify-center gap-4">
            ...
            {isSuccess && (
              <p className="text-center text-3xl text-white">Success!</p>
            )}
            {isIdle && (
              <form
              ...
              >
                <label className="flex flex-col items-center text-white">
                  Name
                  <input
                    className="word-spacing-half rounded-xl px-4 py-2 text-lg text-black transition-colors duration-200 ease-in-out hover:bg-white/20 hover:text-white"
                    type="text"
                    name="name"
                  />
                </label>
